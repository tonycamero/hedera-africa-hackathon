  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-md mx-auto bg-slate-900/95 border border-white/20 backdrop-blur-xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="phone" className="space-y-4 mt-6">
            <div className="text-center space-y-4">
              ...
              <div className="text-xs text-white/50 bg-white/5 rounded-lg p-3 border border-white/10">
        ...
        <div className="text-xs text-white/50 text-center mt-4 p-3 bg-white/5 rounded-lg border border-white/10">
