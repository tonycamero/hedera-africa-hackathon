      ...
      <div className="fixed inset-0 flex items-center justify-center p-4 pointer-events-none">
        <div className="pointer-events-auto animate-in zoom-in-90 fade-in-0 duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]">
          ...
          ">
            ...
            <div className="mb-4 pb-3 border-b border-[#00F6FF]/20">
              <h2 className="text-white text-xl font-bold bg-gradient-to-r from-white to-[#00F6FF] bg-clip-text text-transparent flex items-center justify-center gap-2">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#00F6FF]/30 to-emerald-500/30 flex items-center justify-center border border-[#00F6FF]/30 shadow-lg">
                  <QrCode className="w-4 h-4 text-[#00F6FF]" />
                </div>
                QR Exchange
              </h2>
            </div>
        ...
        <Tabs defaultValue="mine" className="w-full">
          <TabsList className="grid grid-cols-2 mb-3 bg-white/5 border border-white/10">
            <TabsTrigger 
              value="mine" 
              className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#00F6FF]/20 data-[state=active]:to-emerald-500/20 data-[state=active]:text-white data-[state=active]:border-[#00F6FF]/30"
            >
              <QrCode className="w-4 h-4 mr-2" /> Share My QR
            </TabsTrigger>
            <TabsTrigger 
              value="scan"
              className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-emerald-500/20 data-[state=active]:to-[#00F6FF]/20 data-[state=active]:text-white data-[state=active]:border-emerald-500/30"
            >
          ...
          <TabsContent value="mine" className="space-y-3">
            <div className="backdrop-blur-md bg-gradient-to-br from-white/10 to-white/5 border border-[#00F6FF]/20 rounded-lg p-4 flex flex-col items-center relative overflow-hidden">
              {/* Subtle glow effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-[#00F6FF]/5 to-emerald-500/5 animate-pulse rounded-lg" />
              
              <div className="w-36 h-36 bg-white/95 rounded-lg flex items-center justify-center mb-3 shadow-2xl border-2 border-[#00F6FF]/30 relative z-10">
                {qrDataUrl ? (
                  <>
                    ...
                    <div className="absolute inset-1 border-2 border-transparent">
                      <div className="absolute top-0 left-0 w-3 h-3 border-t-2 border-l-2 border-[#00F6FF]/60 animate-pulse" />
                      ...
                      <div className="absolute bottom-0 right-0 w-3 h-3 border-b-2 border-r-2 border-[#00F6FF]/60 animate-pulse" />
                    </div>
                  </>
                ) : (
                  <div className="flex flex-col items-center text-slate-600">
                    <div className="w-5 h-5 border-2 border-[#00F6FF] rounded-full border-t-transparent animate-spin mb-2" />
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#00F6FF]/10 to-emerald-500/10 rounded-lg blur-lg -z-10 animate-pulse" />
              ...
              <div className="w-full space-y-2 relative z-10">
                ...
                <div className="flex gap-2">
                  <Input 
                    readOnly 
                    value={inviteCode} 
                    className="text-xs font-mono bg-white/5 border-white/10 text-white/70 focus:border-[#00F6FF]/50" 
                  />
                  <Button 
                    type="button" 
                    size="sm"
                    className="bg-gradient-to-r from-[#00F6FF]/80 to-cyan-500/80 hover:from-[#00F6FF] hover:to-cyan-500 text-white font-medium shadow-lg border border-[#00F6FF]/40"
                    onClick={() => { 
          ...
          <TabsContent value="scan" className="space-y-4">
            {detectorSupported ? (
              <div className="space-y-4 w-full">
                ...
                <div className="backdrop-blur-md bg-gradient-to-br from-white/10 to-white/5 border border-emerald-500/20 rounded-lg p-4 relative overflow-hidden w-full">
                  <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-[#00F6FF]/5 animate-pulse" />
            ...
            <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-lg p-4 space-y-4 w-full">
              ...
              <Input 
                ...
                className="bg-white/5 border-white/10 text-white placeholder:text-white/40 focus:border-[#00F6FF]/50" 
              />
