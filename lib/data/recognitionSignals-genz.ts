...
// Recognition Signals v2 - GenZ cultural overlay
export const recognitionSignals: RecognitionSignal[] = [
...

  {
    ...
    isActive: true,
    trustValue: 0.5,
    extendedDescription: `This person has main character energy when it comes to strategy. They're not just reacting to the game - they're three moves ahead, calling plays nobody else saw coming. Pure visionary vibes.`,
    rarity: 'Legendary',
    ...
    culturalContext: `GenZ values authentic leadership that doesn't feel corporate`,
    tips: [
  ...
  },
  {
    ...
    isActive: true,
    trustValue: 0.5,
    extendedDescription: `The ultimate hype person who makes the whole squad better. They create that safe space where everyone can be themselves and pop off. When they're around, the whole vibe just hits different.`,
    rarity: 'Legendary',
    stats: {"popularity": 90, "impact": 95, "authenticity": 92, "difficulty": 85},
    traits: {
      personality: [],
  ...
  },
  {
    ...
    isActive: true,
    trustValue: 0.4,
    extendedDescription: `When everyone's spiraling, this person just makes the call - no cap, no overthinking. They trust their gut, commit to the move, and own the outcome. Built different when pressure hits.`,
    rarity: 'Rare',
  ...
  },
  {
    ...
    isActive: true,
    trustValue: 0.4,
    extendedDescription: `This person architects the vibes. Not in a forced HR way - they genuinely create spaces where people feel safe to be themselves and the culture just naturally slaps.`,
    rarity: 'Rare',
    stats: {"popularity": 80, "impact": 88, "authenticity": 88, "difficulty": 75},
    traits: {
      personality: [],
  ...
  },
  {
    ...
    isActive: true,
    trustValue: 0.4,
    extendedDescription: `When everything's changing and people are stressed, this person guides everyone through the plot twist. They keep it real about what's hard but help you see why the change hits.`,
    rarity: 'Rare',
    stats: {"popularity": 80, "impact": 88, "authenticity": 88, "difficulty": 75},
    traits: {
      personality: [],
  ...
  },
  {
    ...
    isActive: true,
    trustValue: 0.4,
    extendedDescription: `This person sees your potential before you do and actively helps you glow up. They're invested in your growth journey and celebrate every level-up moment with genuine hype.`,
    rarity: 'Rare',
    stats: {"popularity": 80, "impact": 88, "authenticity": 88, "difficulty": 75},
    traits: {
      personality: [],
  ...
  },
  {
    ...
    isActive: true,
    trustValue: 0.4,
    extendedDescription: `Pure 'for the team' energy. They're not ego-tripping on being the boss - they're literally just clearing obstacles so everyone else can shine. That's real leadership.`,
    rarity: 'Rare',
    stats: {"popularity": 80, "impact": 88, "authenticity": 88, "difficulty": 75},
    traits: {
      personality: [],
  ...
  },
  {
    ...
    isActive: true,
    trustValue: 0.3,
    extendedDescription: `When the group chat is divided, this person somehow gets everyone to agree without forcing it. They make everyone feel heard and find that middle ground that actually works.`,
    rarity: 'Common',
...

  {
    ...
    isActive: true,
    trustValue: 0.4,
    extendedDescription: `Has that day one energy - when you need them, they're there. No flaking, no excuses. They understand that showing up is literally the foundation of everything.`,
    rarity: 'Rare',
    stats: {"popularity": 80, "impact": 88, "authenticity": 88, "difficulty": 75},
    traits: {
      personality: [],
  ...
  },
  {
    ...
    isActive: true,
    trustValue: 0.4,
    extendedDescription: `This person keeps it 100 even when the truth is uncomfortable. They're not being mean - they're being real because they actually care enough to be honest.`,
    rarity: 'Rare',
    stats: {"popularity": 80, "impact": 88, "authenticity": 88, "difficulty": 75},
    traits: {
      personality: [],
  ...
  },
  {
    ...
    isActive: true,
    trustValue: 0.3,
    extendedDescription: `Unapologetically themselves 24/7. They're not code-switching, not performing for approval - just existing in their truth. That energy gives everyone else permission to do the same.`,
    rarity: 'Common',
    stats: {"popularity": 75, "impact": 80, "authenticity": 85, "difficulty": 65},
    traits: {
      personality: [],
  ...
  },
  {
    ...
    isActive: true,
    trustValue: 0.4,
    extendedDescription: `Has incredible emotional intelligence - reads the room instantly, picks up on subtle energy shifts, and responds with exactly what's needed. Just gets people on a deeper level.`,
    rarity: 'Rare',
    stats: {"popularity": 80, "impact": 88, "authenticity": 88, "difficulty": 75},
    traits: {
      personality: [],
...

  {
    ...
    isActive: true,
    trustValue: 0.4,
    extendedDescription: `Always linking people up who vibe. They see connections others miss and create intro's that actually matter. Your network grows just from knowing them.`,
    rarity: 'Rare',
    stats: {"popularity": 80, "impact": 88, "authenticity": 88, "difficulty": 75},
    traits: {
      personality: [],
  ...
  },
  {
    ...
    isActive: true,
    trustValue: 0.4,
    extendedDescription: `Creates that rare safe space where you can actually be vulnerable without judgment. They hold your secrets like Fort Knox and respond to real talk with genuine support.`,
    rarity: 'Rare',
    stats: {"popularity": 80, "impact": 88, "authenticity": 88, "difficulty": 75},
    traits: {
      personality: [],
...

  {
    ...
    isActive: true,
    trustValue: 0.5,
    extendedDescription: `Starts movements that actually matter. Not performative activism - real organizing that gets the community mobilized and creates actual change. Built different.`,
    rarity: 'Legendary',
    stats: {"popularity": 90, "impact": 95, "authenticity": 92, "difficulty": 85},
    traits: {
      personality: [],
