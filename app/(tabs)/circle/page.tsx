...
export default function CirclePage() {
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-4 space-y-6">
      ...
      <Card className="bg-gradient-to-br from-slate-800/60 to-slate-900/50 border-2 border-[#00F6FF]/20 shadow-[0_0_30px_rgba(0,246,255,0.15),0_0_60px_rgba(0,246,255,0.05)] relative before:absolute before:inset-0 before:rounded-lg before:p-[1px] before:bg-gradient-to-r before:from-[#00F6FF]/20 before:via-transparent before:to-[#00F6FF]/20 before:-z-10 before:animate-pulse">
        <CardContent className="p-6 relative z-10">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <Button
              className="w-full h-12 text-base font-medium bg-gradient-to-r from-[#00F6FF] to-cyan-400 text-black hover:from-[#00F6FF]/90 hover:to-cyan-400/90 active:scale-95 transition-all shadow-[0_0_20px_rgba(0,246,255,0.4),0_0_40px_rgba(0,246,255,0.2)] hover:shadow-[0_0_25px_rgba(0,246,255,0.5),0_0_50px_rgba(0,246,255,0.3)]"
