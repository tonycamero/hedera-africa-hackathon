  ...
  return (
    <div className="max-w-md mx-auto px-4 py-4 space-y-6">
      ...
      <div className="text-center">
        <Button 
          className="bg-gradient-to-r from-[#00F6FF] to-cyan-500 hover:from-[#00F6FF]/80 hover:to-cyan-500/80 text-black font-bold px-6 py-3 text-sm rounded-lg transition-all duration-300 hover:scale-105"
          onClick={() => {
            console.log('👥 Invite Peer clicked')
            toast.success('Opening contact selector...', {
              description: 'Add a trusted peer to your circle',
              duration: 2000
            })
            // TODO: Wire to existing add contact/trust flow
          }}
        >
